...
class MQAEETriClsTrainer(object):
    ...
    def load_model(self, checkpoint=None):
        span_checkpoint = "./outputs/MQAEE_ED_ace05_bert-large-cased/20240422_201837013/"
        ...
        for dt in data:
            ...
            for trigger in dt["triggers"]:
                ...
                for neg_event_type in label_list_:
                    ...
                    arg_roles = ', '.join(sorted(patterns[self.config.dataset][neg_event_type].keys()))
    ...
    def predict(self, data):
        assert self.tokenizer and self.span_model and self.model
